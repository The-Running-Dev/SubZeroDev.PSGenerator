...
This roadmap is ordered by dependency and release risk. `20-contract.md` defines
...
Moved to [`90-decisions.md`](90-decisions.md) on 2026-08-04. A roadmap is rewritten as
work completes; a decision register must not be.
## 1. MVP blockers
...
- [x] Reconcile `20-contract.md`, `README.md`, command help, examples, and generated
