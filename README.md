...
- [Infer commands from a script directory](https://psgenerator.subzerodev.com/getting-started/script-directories)
...
- [Directory inspection](https://psgenerator.subzerodev.com/reference/inspection)
